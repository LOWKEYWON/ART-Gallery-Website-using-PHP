<?php
    ...
    if(isset($_POST['add_to_cart'])){
      ...
      $select_cart = mysqli_query($con, "SELECT * FROM `tblcart` WHERE Title = '$product_name'");
      if(mysqli_num_rows($select_cart) > 0){
         echo "<script>alert('Product Already Added');</script>";  
      }else{
         $insert_product = mysqli_query($con, "INSERT INTO `tblcart`(Artpdid, Title, SellingPricing, Artist) VALUES('$cid', '$product_name', '$product_price', '$product_Artist')");
...
<html lang="zxx">
   <head>
      <title>MEGHASAMAYAM | Single Product</title>
...
?>
            ...
            <?php endif;?>
                  ...
                  <div class="col-lg-8 single-right-left simpleCart_shelfItem">
                     <h3><?php echo $row['Title'];?> (<?php echo $row['Name'];?>)</h3>
                     ...
                     <div class="color-quality">
                        <div class="color-quality-right">
                           ...
                           <h5>Prize : <?php echo $row['SellingPricing'];?></h5>
                     ...
                     <div class="occasion-cart">
                        <div>
                           <h4>
                                             <button class="btn btn-success"><a href="art-enquiry.php?eid=<?php echo $row['apid'];?>" >Enquiry</a></button>
                                             <br>
                                             <br>
                                             <input type="hidden" name="cid" value="<?php echo $row['apid'] ?>">
                                             <input type="hidden" name="product_name" value="<?php echo $row['Title'] ?>">
                                             <input type="hidden" name="product_price" value="<?php echo $row['SellingPricing']; ?>">
                                             <input type="hidden" name="product_Artist" value="<?php echo $row['Name']; ?>">

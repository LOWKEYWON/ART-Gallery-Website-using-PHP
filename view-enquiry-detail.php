...
if (strlen($_SESSION['meghasamayam']==0)) {
   ...
   if(isset($_POST['submit']))
  {
      ...
      if ($query) {
        ...
        try{
          ...
          $mail->SMTPAuth = true;
          $mail->Username = 'arshitharavind10@gmail.com'; // Gmail address which you want to use as SMTP server
          $mail->Password = 'colkbpfovdnvlnei'; // Gmail address Password
          $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
          $mail->Port = '587';
      
          $mail->setFrom('arshitharavind10@gmail.com'); // Gmail address which you used as SMTP server
          $mail->addAddress('arshitharavind@gmail.com'); // Email address where you want to receive emails (you can use any of your gmail address including the gmail address which you used as SMTP server)
      
          $mail->isHTML(true);
          $mail->Subject = 'Enquiry reply (MEGHASAMAYAM)';
          $mail->Body = "<h3>Reply Regarding Art Enquiry : $remark </h3>";
      
          $mail->send();
          echo '<script>alert("Remark has been send")</script>';
        } catch (Exception $e){
...
<head>
  ...
  <title>View Enquiry | MEGHASAMAYAM</title>
...
<tr>
  ...
  <tr align="center">
    <td colspan="2"><button type="submit" name="submit" class="btn btn-primary btn-sm"><i class="fa fa-dot-circle-o"></i> Send</button></td>
  </tr>
  </form>
